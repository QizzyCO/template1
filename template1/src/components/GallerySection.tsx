  ...
  return (
    <div id="gallery-root">
      <section className="py-20 bg-mint text-center">
        ...
        <h2 className="text-5xl md:text-6xl font-serif mt-4 text-secondary">Sudut <span className="italic">Favorit</span></h2>
      </section>
      ...
      <section className="py-20 bg-mint flex flex-col items-center justify-center">
        <Link to="/gallery">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-10 py-4 border-2 border-secondary text-secondary font-bold rounded-full hover:bg-secondary hover:text-white transition-all uppercase tracking-widest text-sm"
          >
            Selebihnya
          </motion.button>
        </Link>
