        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            <motion.button
              ...
              className="bg-white text-black px-8 md:px-10 py-4 md:py-5 rounded-full text-lg md:text-xl font-medium flex items-center gap-2 shadow-2xl shadow-black/40 transition-colors"
            >
