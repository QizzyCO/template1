    ...
    <section id="find-us" className="py-32 bg-cream overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <motion.span 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-white font-semibold uppercase tracking-[0.3em] text-xs"
        >
          Hubungi Kami
        </motion.span>
        <motion.h2 
          ...
          className="text-5xl md:text-7xl font-serif mt-4 mb-12 text-white"
        >
          Sapa Kami di <span className="italic text-accent">Sosial Media</span>
        </motion.h2>
