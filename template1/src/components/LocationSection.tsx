    ...
    <section id="location" className="py-24 bg-mint">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <span className="text-accent font-semibold uppercase tracking-[0.2em] text-sm">Lokasi Kami</span>
              <h2 className="text-5xl md:text-6xl font-serif mt-4 text-white">
                Kunjungi <span className="italic text-accent">Jasty Garden</span>
              </h2>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-xl font-serif font-bold text-white mb-1">Alamat</h4>
