...
export default function SocialVideoSection() {
  ...
  return (
    <section ref={sectionRef} id="reviews" className="py-24 md:py-32 bg-[#2d4a3e] text-white overflow-hidden relative">
      {/* Background Floating Text */}
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex flex-col justify-center items-center pointer-events-none select-none opacity-[0.03] overflow-hidden z-0">
        <motion.h2 
          style={{ x: textXLeft }}
        ...
        <motion.h2 
          style={{ x: textXRight }}
          className="text-[12rem] md:text-[18rem] font-serif whitespace-nowrap leading-none italic text-accent"
        >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="text-center mb-16 md:mb-24">
          <motion.span 
            ...
            viewport={{ once: true }}
            className="text-white/70 font-semibold uppercase tracking-[0.3em] text-xs"
          >
            Momen Penuh Rasa
          </motion.span>
          <h2 className="text-5xl md:text-7xl font-serif mt-4 leading-[0.9] text-white">
            Cerita Jasty <span className="italic text-accent">di Sosial Media</span>
          </h2>
        </div>
