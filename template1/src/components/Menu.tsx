            ...
            >
              <div className="relative aspect-square rounded-2xl md:rounded-[32px] overflow-hidden mb-4 md:mb-6 shadow-lg shadow-primary/10">
                <img 
                  ...
                  loading="lazy"
                />
                <div className="absolute top-2 right-2 md:top-4 md:right-4 bg-[#164e32] text-white px-3 md:px-5 py-1 rounded-full font-serif font-bold text-[10px] md:text-sm shadow-sm group-hover:bg-[#25D366] transition-colors flex items-center gap-1.5 border border-white/10">
                  <span className="w-1.5 h-1.5 bg-white rounded-full animate-ping" />
                  {item.price}
                </div>
              </div>
              <h3 className="text-lg md:text-2xl font-serif font-bold mb-1 md:mb-2 group-hover:text-[#164e32] transition-colors text-secondary">
                {item.name}
              </h3>
