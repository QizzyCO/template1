      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <motion.h2 
            ...
            className="text-5xl md:text-6xl font-serif mt-4 mb-6 text-white"
          >
            Nikmati Hidangan Di Mana Setiap Kreasi Adalah <br />
            <span className="italic text-accent">Mahakarya Cita Rasa</span>
          </motion.h2>
        </div>
        ...
        >
          {filteredItems.map((item) => (
            ...
            >
              ...
              <h3 className="text-lg md:text-2xl font-serif font-bold mb-1 md:mb-2 group-hover:text-accent transition-colors text-white">
                {item.name}
              </h3>
              <p className="text-white/60 text-[10px] md:text-sm leading-relaxed line-clamp-2 md:line-clamp-none">
                {item.description}
              </p>
            </motion.div>
          ))}
