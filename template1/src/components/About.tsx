      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <ScrollFloat
            ...
            textClassName="text-6xl md:text-8xl font-serif text-secondary tracking-tight"
            animationDuration={1}
            stagger={0.05}
          >
            Tentang Kami
        ...
        >
          ...
          <motion.div 
            ...
            whileInView={{ scale: 1 }}
            viewport={{ once: true }}
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-secondary rounded-full flex flex-col items-center justify-center text-white text-center border-8 border-white"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl md:text-6xl font-serif mt-4 mb-8 leading-tight text-secondary">
          ...
          <div className="space-y-6 mb-10">
            {[
              ...
              >
                ...
                <p className="font-medium text-secondary/80">{item}</p>
              </motion.div>
            ))}
          </div>
          ...
          <motion.button 
            ...
            className="bg-secondary text-white px-10 py-4 rounded-full text-lg font-medium hover:bg-secondary/90 transition-all shadow-xl shadow-secondary/20"
          >
            Baca Kisah Kami
          </motion.button>
        </motion.div>
