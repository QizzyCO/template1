  ...
  return (
    <div className="min-h-screen bg-mint pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-secondary hover:text-forest transition-colors mb-12 group"
        >
        ...
        <div className="text-center mb-16">
          <span className="text-secondary/60 font-semibold uppercase tracking-[0.3em] text-sm">
            Arsip Visual
          </span>
          <h1 className="text-5xl md:text-7xl font-serif mt-4 text-secondary">
            Galeri <span className="italic">Lengkap</span>
          </h1>
        </div>
